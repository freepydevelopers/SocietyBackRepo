# Generated by Django 2.1.7 on 2019-03-21 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('empt', 'empt'), ('iso', 'iso'), ('ist', 'ist')], default='iso', max_length=3)),
                ('createdon', models.DateTimeField(auto_now_add=True)),
                ('updatedon', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unittype', models.CharField(choices=[('01r', '1 room kitchen'), ('01b', '01b'), ('15b', '15b'), ('02b', '02b'), ('25b', '25b'), ('03b', '03b'), ('04b', '04b'), ('pen', 'Pent')], default='01b', max_length=3)),
                ('createdon', models.DateTimeField(auto_now_add=True)),
                ('updatedon', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('adm', 'adm'), ('own', 'own'), ('ten', 'ten'), ('emp', 'emp')], default='own', max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
        ...
        migrations.AddField(
            model_name='building',
            name='elevators',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Core.Elevator'),
        ),
        migrations.AddField(
            model_name='building',
            name='society',
